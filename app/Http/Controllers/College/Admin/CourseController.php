...
class CourseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('college.admin.course.courseList',array('title'=>$title,'grid_title'=>$grid_title,'data'=>$data,'course_type'=>$course_type));
    }
    ...
    public function create()
    {
        $title = "Create Course";
        $course_type = Course::COURSE_TYPE;
        return view('college.admin.course.addCourse',array('title'=>$title,'course_type'=>$course_type));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('college.admin.courses')->with('message',"Course has been saved...!");
    }
    ...
    public function edit($id)
    {
        ...
        if(!empty($data))
        {
            return view('college.admin.course.editCourse',array('title'=>$title,'data'=>$data,'course_type'=>$course_type));
        }
        else
        {
            abort(404);
