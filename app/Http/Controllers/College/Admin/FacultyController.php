...
class FacultyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('college.admin.faculties')->with('message',"Data has been saved...!");
    }
    ...
    public function edit($id)
    {
        ...
        if(!empty($data))
        {
            ...
            return view('college.admin.users.normal.edit',array('title'=>$title,'data'=>$data,'roleData'=>$roleData,'user_role_data'=>$user_role_arr));
        }
        else
        {
            abort(404);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('college.admin.faculties')->with('message',"Data has been updated...!");
