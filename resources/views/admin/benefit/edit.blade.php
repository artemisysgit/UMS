    ...
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action=" {{ route('updateBenefit',$data->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            @if($data->image)
                                <img src="/images/admin/benefit/{{ $data->image }}" style="height: 50px;width:100px;">
                            @else
