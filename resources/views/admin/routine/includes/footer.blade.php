...
<script src="{{ url('assets/vendor/libs/bootstrap-daterangepicker/bootstrap-daterangepicker.js') }}"></script>
<script src="{{ url('assets/vendor/libs/jquery-timepicker/jquery-timepicker.js') }}"></script>
<script src="{{ url('assets/vendor/libs/pickr/pickr.js') }}"></script>
<!-- <script src="{{ url('assets/js/forms-pickers.js') }}"></script> -->
<!----------------------End------------------------------>

<!-- Custom JS -->
<script src="{{ url('assets/admin_assets/js/superadmin/routine/custom.js') }}"></script>
