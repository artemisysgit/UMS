...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('subject_combination_list',$subID) }}">Combination List</a> /</span> {{ $title }}</h4>
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/subjects/combinations/update/'.$subID.'/'.$editData->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="combination[]" id="combination" class="form-control" onchange="maxAllowedMultiselect(this, 2)" multiple>
                                ...
                                <option value="{{ $sub->id }}" <?php echo in_array($sub->id,$subjiect_arr) ? 'selected':'' ?>>{{ $sub->title }}</option>
                                @endforeach
                                @endif
                            </select>
