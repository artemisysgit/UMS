    ...
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action=" {{ route('college.admin.updateBenefit',$data->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="bs-validation-descr" name="short_descr" rows="3"
                                required>{{ $data->short_descr }}</textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @if($data->image)
                                <img src="/images/college/benefit/{{ $data->image }}" style="height: 50px;width:100px;">
                            @else
