...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="{{ route('college.admin.departments') }}">Departments</a> /</span> {{ $title }}</h4>
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action=" {{ route('college.admin.updateDepartment',$data->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="bs-validation-name" name="title" placeholder="Department Title" value="{{ $data->title }}"
                                required />
