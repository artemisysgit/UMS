    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <form id="upload_frm" action="{{ route('college.admin.uploadProfile') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <form id="profile_frm" action="{{ route('college.admin.saveProfile') }}" method="POST"  enctype="multipart/form-data">
