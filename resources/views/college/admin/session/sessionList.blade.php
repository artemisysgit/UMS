...
<div class="breadcrumb d-flex justify-content-end me-3 mt-3">
    <a href="{{ route('college.admin.addSession') }}" class="btn btn-primary">Add New</a>
</div>
        ...
        <table class="datatables-basic table" id="tbl">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $r->name }}</td>
                    <td><a href="{{  url('college/admin/sessions/edit/'.$r->id) }}" class="btn btn-primary btn-sm">edit</a></td>
                </tr>
