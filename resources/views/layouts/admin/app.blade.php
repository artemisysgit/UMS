...
<html
  ...
  <head>
    ...
    <?php if($controller == 'AdminuserController'){?>
        @include('admin.users.admin.includes.header');
    <?php }?>

    <?php if($controller == 'CourseController'){?>
        @include('admin.course.includes.header');
    <?php }?>
    ...
    <?php if($controller == 'SemesterController'){?>
        @include('admin.semester.includes.header');
    <?php }?>

    <?php if($controller == 'DepartmentController'){?>
        @include('admin.department.includes.header');
    <?php }?>
    ...
    <?php if($controller == 'AssignTeacherController'){?>
        @include('admin.assignment.teachers.includes.header');
    <?php }?>

    <?php if($controller == 'HodController'){?>
        @include('admin.hod.includes.header');
    <?php }?>

    <?php if($controller == 'TimeController'){?>
        @include('admin.time.includes.header');
    <?php }?>

    <?php if($controller == 'RoutineController'){?>
        @include('admin.routine.includes.header');
    <?php }?>

    <?php if($controller == 'CmsController'){?>
        @include('admin.cms.includes.header');
    <?php }?>
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboards -->
            <li class="menu-item {{ $admin_menu_active }}">
            ...
            <li class="menu-item {{ $admin_menu_active }}">
              ...
              <ul class="menu-sub">
                ...
                @if(AUTH::guard('admin')->user()->is_admin == 1 && (int)AUTH::guard('admin')->user()->collegeID == 0)
                    ...
                    <!-- Academy menu start -->
                    <li class="menu-item {{ $admin_academy_menu_active }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ activeMenu('admin/assign-teachers') }}">
                                <a href="{{ route('assignList') }}" class="menu-link">
                                    <div data-i18n="Assign Teacher">Assign Teacher</div>
                                </a>
                            </li>
                            <li class="menu-item {{ activeMenu('admin/hod') }}">
                                <a href="{{ route('hodList') }}" class="menu-link">
                                    <div data-i18n="HOD List">HOD List</div>
                                </a>
                            </li>
                            <li class="menu-item {{ activeMenu('admin/time') }}">
                                <a href="{{ route('timeList') }}" class="menu-link">
                                    <div data-i18n="Time List">Time List</div>
                                </a>
                            </li>
                            <li class="menu-item {{ activeMenu('admin/routine') }}">
                                <a href="{{ route('routineList') }}" class="menu-link">
            ...
            <li class="menu-item {{ $admin_benefit_menu_active }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons ti ti-book"></i>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item {{ activeMenu('admin/benefits') }}">
                        <a href="{{ route('benefits') }}" class="menu-link">
            ...
            <!-- CMS menu start -->
            <li class="menu-item {{ $admin_cms_menu_active }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons ti ti-book"></i>
    ...
    <?php if($controller == 'AdminuserController'){?>
        @include('admin.users.admin.includes.footer');
    <?php }?>

    <?php if($controller == 'CourseController'){?>
        @include('admin.course.includes.footer');
    <?php }?>

    <?php if($controller == 'SessionController'){?>
        @include('admin.session.includes.footer');
    <?php }?>

    <?php if($controller == 'SemesterController'){?>
        @include('admin.semester.includes.footer');
    <?php }?>

    <?php if($controller == 'DepartmentController'){?>
        @include('admin.department.includes.footer');
    <?php }?>

    <?php if($controller == 'RoleController'){?>
        @include('admin.role.includes.footer');
    <?php }?>
    ...
    <?php if($controller == 'FacultyController'){?>
        @include('admin.users.normal.includes.footer');
    <?php }?>
    ...
    <?php if($controller == 'AssignTeacherController'){?>
        @include('admin.assignment.teachers.includes.footer');
    <?php }?>
    ...
    <?php if($controller == 'TimeController'){?>
        @include('admin.time.includes.footer');
    <?php }?>

    <?php if($controller == 'RoutineController'){?>
        @include('admin.routine.includes.footer');
    <?php }?>

    <?php if($controller == 'CmsController'){?>
        @include('admin.cms.includes.footer');
    <?php }?>
