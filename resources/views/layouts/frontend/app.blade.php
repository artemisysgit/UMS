...
<div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
        ...
        <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0">
            ...
            <ul class="menu-inner">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                    <a href="{{ route('student-departments') }}" class="menu-link">
                    ...
                    <li class="menu-item">
                    <a href="{{ route('student-faculties') }}" class="menu-link">
    ...
    <?php if($controller == 'CourseController'){?>
        <script src="{{ url('assets/student/js/course/custom.js' ) }}"></script>
    <?php }?>

    <?php if($controller == 'DepartmentController'){?>
        <script src="{{ url('assets/student/js/department/custom.js' ) }}"></script>
    <?php }?>

    <?php if($controller == 'FacultyController'){?>
        <script src="{{ url('assets/student/js/faculty/custom.js' ) }}"></script>
    <?php }?>
