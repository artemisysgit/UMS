...
<body>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="courses-slide">
                        <div class="courses-slide-main">
                            <div class="courses-slider-img" style="width:70%;height:70%;margin:0 auto;">
                            ...
                            <div class="courses-slider-text">
                                <a href="{{  url('/faculties/faculty-details/'.$teacher->id) }}">{{ $teacher->name }}</a>
    ...
    <script>
        $(function(){
            ...
            resize_div_same_size('courses-slider-text');
        });
    </script>
</body>
