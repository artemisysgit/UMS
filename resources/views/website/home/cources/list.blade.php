<section class="courses py">
        <div class="courses4"><img src="{{ url('assets/website/assets/images/courses/courses4.png') }}" alt=""></div>
        <div class="container">
            <div class="heading">
                <h5>Top Popular Courses <div class="sub-heading-bg"><img src="{{ url('assets/website/assets/images/heading/heading-bg.png') }}"
                            alt=""></div>
                </h5>
        ...
        @if(!empty($course_type))
            ...
            <div id="{{ $k }}" class="tabcontent" style="{{ $loop->iteration == 1?'display: block;':'' }}">
    ...
    <script src="{{ url('assets/website/assets/js/course/custom.js' ) }}"></script>
