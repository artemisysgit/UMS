<section class="introduce mb">
        <div class="container">
            <div class="row g-4 ">
                <div class="col-lg-6">
                    <div class="heading">
                        <h5>Skilled Introduce <div class="sub-heading-bg"><img
                                    src="{{ url('assets/website/assets/images/heading/heading-bg.png') }}" alt=""></div>
                        </h5>
                        <h2>Our top class & professional instructors in one place</h2>
        ...
        <div class="Introduce-icon3"><img src="{{ url('assets/website/assets/images/introduce/Introduce-icon3.png') }}" alt=""></div>
        <div class="Introduce-icon4"><img src="{{ url('assets/website/assets/images/introduce/Introduce-icon4.png') }}" alt=""></div>
        <div class="Introduce-icon5"><img src="{{ url('assets/website/assets/images/introduce/Introduce-icon5.png') }}" alt=""></div>
    </section>
