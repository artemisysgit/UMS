...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?php echo e(route('departments')); ?>">Roles</a> /</span> <?php echo e($title); ?></h4>
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('saveRole')); ?>" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>

                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label class="form-label" for="bs-validation-name">Role Title</label>
                            <input type="text" class="form-control" id="bs-validation-name" name="title" placeholder="Role Title" required />
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/admin/role/create.blade.php ENDPATH**/ ?>