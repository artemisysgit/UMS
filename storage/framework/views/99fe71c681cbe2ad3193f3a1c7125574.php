    ...
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('saveRoutine')); ?>" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="sem" id="sem" class="form-select">
                                ...
                                <?php if(!empty($semData)): ?>
                                    ...
                                    <?php $__currentLoopData = $semData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($d->id); ?>"><?php echo e($d->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="times" id="times" class="form-select">
                                ...
                                <?php if(!empty($timeData)): ?>
                                    ...
                                    <option value="<?php echo e($t->id); ?>"><?php echo e($t->start_time .' - '.$t->end_time); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/admin/routine/create.blade.php ENDPATH**/ ?>