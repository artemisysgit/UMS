...
<body>
            ...
            <div class="about-counter-main d-flex align-items-center ">
                <div class="about-counter-sub">
                    <div class="about-counter-sub-box d-flex align-items-center">
                        <div class="about-counter-sub-img"><img src="<?php echo e(url('assets/website/assets/images/about-counter/about-counter1.png')); ?>"
                                alt=""></div>
                ...
                <div class="about-counter-sub">
                    <div class="about-counter-sub-box d-flex align-items-center">
                        <div class="about-counter-sub-img"><img src="<?php echo e(url('assets/website/assets/images/about-counter/about-counter2.png')); ?>"
                                alt=""></div>
                        <div class="about-counter-sub-text">
                            <h3>93+</h3>
                            <p>Best Professors</p>
                ...
                <div class="about-counter-sub">
                    <div class="about-counter-sub-box d-flex align-items-center">
                        <div class="about-counter-sub-img"><img src="<?php echo e(url('assets/website/assets/images/about-counter/about-counter3.png')); ?>"
                                alt=""></div>
                        <div class="about-counter-sub-text">
                            <h3>87+</h3>
                            <p>Award Achieved</p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-univercity-img">
                        <img src="<?php echo e(url('assets/website/assets/images/about-univercity/about-univercity.png')); ?>" alt="">
                        <div class="about-univercity-icon1"><img
                                src="<?php echo e(url('assets/website/assets/images/about-univercity/about-univercity-icon1.png')); ?>" alt=""></div>
                        <div class="about-univercity-icon2"><img
                                src="<?php echo e(url('assets/website/assets/images/about-univercity/about-univercity-icon2.png')); ?>" alt=""></div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-univercity-text">
                        <div class="heading">
                            <h5>About Our University <div class="sub-heading-bg"><img
                                        src="<?php echo e(url('assets/website/assets/images/heading/heading-bg.png')); ?>" alt=""></div>
                            </h5>
    ...
    <section class="scholarship mb">
        <div class="container">
            <div class="scholarship-img"><img src="<?php echo e(url('assets/website/assets/images/scholarship/Scholarship-Charecter.png')); ?>" alt=""></div>
    ...
    <section class="professor mb">
        <div class="professor-icon"><img src="<?php echo e(url('assets/website/assets/images/professor/profesor-icon.png')); ?>" alt=""></div>
        <div class="container">
            <div class="heading">
                <h5>Skilled Introduce <div class="sub-heading-bg"><img src="<?php echo e(url('assets/website/assets/images/heading/heading-bg.png')); ?>"
                            alt=""></div>
            ...
            <div class="professor-slider">
                    ...
                    <a href="#">
                        <div class="professor-team">
                            <div class="professor-team-img">
                                <img src="<?php echo e(url('assets/website/assets/images/professor/professor1.png')); ?>" alt="">
                            </div>
                ...
                <div class="professor-slide">
                    <a href="#">
                        <div class="professor-team">
                            <div class="professor-team-img">
                                <img src="<?php echo e(url('assets/website/assets/images/professor/professor2.png')); ?>" alt="">
                            </div>
                            <div class="professor-team-text">
                                <h4>Faye Jackson</h4>
                ...
                <div class="professor-slide">
                    <a href="#">
                        <div class="professor-team">
                            <div class="professor-team-img">
                                <img src="<?php echo e(url('assets/website/assets/images/professor/professor3.png')); ?>" alt="">
                            </div>
                            <div class="professor-team-text">
                                <h4>Faye Jackson</h4>
                                <p>Department: <span>Math</span></p>
                ...
                <div class="professor-slide">
                    <a href="#">
                        <div class="professor-team">
                            <div class="professor-team-img">
                                <img src="<?php echo e(url('assets/website/assets/images/professor/professor4.png')); ?>" alt="">
                            </div>
                            <div class="professor-team-text">
                                <h4>Faye Jackson</h4>
                                <p>Department: <span>Math</span></p>
    ...
    <section class="campus mb">
        <div class="container d-flex align-items-center ">
            <div class="campus-img"><img src="<?php echo e(url('assets/website/assets/images/campus/campus.png')); ?>" alt=""></div>
        ...
        <div class="container">
            ...
            <div class="parents-testimonial-slider">
                <div class="parents-testimonial-slide">
                    <a href="#">
                        <div class="parents-testimonial-img">
                            <img src="<?php echo e(url('assets/website/assets/images/parents-testimonial/parents-testimonial1.png')); ?>" alt="">
                        </div>
                ...
                <div class="parents-testimonial-slide">
                    <a href="#">
                        <div class="parents-testimonial-img">
                            <img src="<?php echo e(url('assets/website/assets/images/parents-testimonial/parents-testimonial2.png')); ?>" alt="">
                        </div>
                        <div class="parents-testimonial-text">
                ...
                <div class="parents-testimonial-slide">
                    <a href="#">
                        <div class="parents-testimonial-img">
                            <img src="<?php echo e(url('assets/website/assets/images/parents-testimonial/parents-testimonial3.png')); ?>" alt="">
                        </div>
                        <div class="parents-testimonial-text">
    ...
    <section class="subscribe about-subscribe mb">
        <div class="container">
            <div class="subscribe-des"><img src="<?php echo e(url('assets/website/assets/images/subscribe/subscribe-des.png')); ?>" alt=""></div>
                ...
                <div class="col-lg-6">
                    <div class="subscribe-img">
                        <div class="subscribe-img-main">
                            <img src="<?php echo e(url('assets/website/assets/images/subscribe/subscribe-main.png')); ?>" alt="">
                            <div class="subscribe-img-sub">
                                <img src="<?php echo e(url('assets/website/assets/images/subscribe/subscribe-sub.png')); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/about_us.blade.php ENDPATH**/ ?>