...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="<?php echo e(route('courses')); ?>">Course</a> /</span> <?php echo e($title); ?></h4>
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('saveCourse')); ?>" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>

                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label class="form-label" for="bs-validation-name">Course Title</label>
                            <input type="text" class="form-control" id="bs-validation-name" name="title" placeholder="Course Title" required />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control flatpickr-validation" name="startDate" id="bs-validation-dob" autocomplete="off"
                                required />
                            <div class="valid-feedback">Looks good!</div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/admin/course/addCourse.blade.php ENDPATH**/ ?>