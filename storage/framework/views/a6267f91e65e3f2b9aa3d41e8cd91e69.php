...
<header>
        <div class="container-fluid ">
            <div class="logo">
                <a href="/"><img src="<?php echo e(url('assets/website/assets/images/logo/logo.png')); ?>" alt=""></a>
            </div>
            <div class="navigation menu">
                <ul class="main-menu menu-toggle">
                    <li><a href="/" class="<?php echo e($home_menu_active); ?> ">Home</a></li>
                    <li><a href="<?php echo e(route('about-us')); ?>" class="<?php echo e($aboutus_menu_active); ?>">About</a></li>
...
<?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/website/includes/header.blade.php ENDPATH**/ ?>