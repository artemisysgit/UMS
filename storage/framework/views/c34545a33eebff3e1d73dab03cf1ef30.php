    ...
    <div class="row mb-4">
        ...
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action=" <?php echo e(route('updateTime',$data->id)); ?>" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                        ...
                        <label class="form-label" for="bs-validation-name">Start Time</label>
                            <input type="text" class="form-control" placeholder="HH:MM" name="start_time" id="start_time" value="<?php echo e($data->start_time); ?>" required/>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="HH:MM" name="end_time" id="end_time" value="<?php echo e($data->end_time); ?>" required/>
                            <div class="valid-feedback">Looks good!</div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/admin/time/edit.blade.php ENDPATH**/ ?>