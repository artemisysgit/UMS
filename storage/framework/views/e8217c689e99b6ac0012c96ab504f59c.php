...
<div class="breadcrumb d-flex justify-content-end me-3 mt-3">
    <a href="<?php echo e(route('college.admin.addCourse')); ?>" class="btn btn-primary">Add New</a>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img src="/images/college/course/<?php echo e($r->id); ?>/<?php echo e($r->image); ?>" alt="" style="height: 50px;width:50px;">
                        <?php endif; ?>
                    </td>
                    ...
                    <td><a href="<?php echo e(url('college/admin/courses/edit/'.$r->id)); ?>" class="btn btn-primary btn-sm">edit</a></td>
                </tr>
...
<?php echo $__env->make('layouts.collegeadmin.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\atsums_multi_auth\resources\views/college/admin/course/courseList.blade.php ENDPATH**/ ?>